...
#define PT_REFERENCE_BIT 3    // Bit de referencia - não usa no fifo
#define PT_REFERENCE_MODE 4   // Tipo de acesso, converter para char
#define PT_AGING_COUNTER 5    // Contador para aging - não usa no fifo
...
int main(int argc, char **argv) {
    ...
    if (evict == NULL) {
        ...
        exit(1);
    } //se o parâmetro da função não for como escrito acima ele aponta um erro 
